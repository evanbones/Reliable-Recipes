...
public class RecipeRuleParserTest extends MinecraftTestBase {
    ...
    void testParseRemoveRecipe() {
        ...
        assertTrue(rule.testJson(new ResourceLocation("wooden_pickaxe"), dummyRecipe));
        assertTrue(rule.testJson(new ResourceLocation("wooden_hoe"), dummyRecipe));
        assertFalse(rule.testJson(new ResourceLocation("wooden_sword"), dummyRecipe));
    }
    ...
    void testParseRemoveBrewingRecipe() {
        ...
        ResourceLocation id = new ResourceLocation("test_brewing");
    ...
    void testParseReplaceInput() {
        ...
        JsonObject dummyRecipe = new JsonObject();
        assertTrue(rule.testJson(new ResourceLocation("stick"), dummyRecipe));
        assertFalse(rule.testJson(new ResourceLocation("othermod", "stick"), dummyRecipe));
    }
    ...
    void testParseReplaceOutput() {
        ...
        JsonObject dummyRecipe = new JsonObject();
        assertTrue(rule.testJson(new ResourceLocation("cake"), dummyRecipe));
        assertFalse(rule.testJson(new ResourceLocation("apple"), dummyRecipe));
    }
    ...
    void testParseRegexFilter() {
        ...
        assertTrue(rule.testJson(new ResourceLocation("golden_sword"), matchingRecipe));
        assertFalse(rule.testJson(new ResourceLocation("iron_sword"), nonMatchingOutput));
        assertFalse(rule.testJson(new ResourceLocation("othermod", "golden_sword"), matchingRecipe));
    }
    ...
    void testParseNotCombinator() {
        ...
        assertFalse(rule.testJson(new ResourceLocation("golden_dagger"), goldRecipe));
        assertTrue(rule.testJson(new ResourceLocation("somemod", "golden_dagger"), goldRecipe));
    }
    ...
    void testParseAndOrCombinators() {
        ...
        assertTrue(rule.testJson(new ResourceLocation("stick"), craftingRecipe));
        assertTrue(rule.testJson(new ResourceLocation("iron_ingot"), blastingRecipe));
        assertFalse(rule.testJson(new ResourceLocation("othermod", "iron_ingot"), blastingRecipe));
        assertFalse(rule.testJson(new ResourceLocation("iron_pickaxe"), craftingRecipe));
    }
