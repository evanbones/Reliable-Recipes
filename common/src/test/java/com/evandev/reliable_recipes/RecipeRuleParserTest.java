...
public class RecipeRuleParserTest extends MinecraftTestBase {
    ...
    void testParseRemoveRecipe() {
        ...
        assertTrue(rule.testJson(ResourceLocation.withDefaultNamespace("wooden_pickaxe"), dummyRecipe));
        assertTrue(rule.testJson(ResourceLocation.withDefaultNamespace("wooden_hoe"), dummyRecipe));
        assertFalse(rule.testJson(ResourceLocation.withDefaultNamespace("wooden_sword"), dummyRecipe));
    }
    ...
    void testParseRemoveBrewingRecipe() {
        ...
        ResourceLocation id = ResourceLocation.withDefaultNamespace("test_brewing");
    ...
    void testParseReplaceInput() {
        ...
        JsonObject dummyRecipe = new JsonObject();
        assertTrue(rule.testJson(ResourceLocation.withDefaultNamespace("stick"), dummyRecipe));
        assertFalse(rule.testJson(ResourceLocation.fromNamespaceAndPath("othermod", "stick"), dummyRecipe));
    }
    ...
    void testParseReplaceOutput() {
        ...
        JsonObject dummyRecipe = new JsonObject();
        assertTrue(rule.testJson(ResourceLocation.withDefaultNamespace("cake"), dummyRecipe));
        assertFalse(rule.testJson(ResourceLocation.withDefaultNamespace("apple"), dummyRecipe));
    }
    ...
    void testParseRegexFilter() {
        ...
        assertTrue(rule.testJson(ResourceLocation.withDefaultNamespace("golden_sword"), matchingRecipe));
        assertFalse(rule.testJson(ResourceLocation.withDefaultNamespace("iron_sword"), nonMatchingOutput));
        assertFalse(rule.testJson(ResourceLocation.fromNamespaceAndPath("othermod", "golden_sword"), matchingRecipe));
    }
    ...
    void testParseNotCombinator() {
        ...
        assertFalse(rule.testJson(ResourceLocation.withDefaultNamespace("golden_dagger"), goldRecipe));
        assertTrue(rule.testJson(ResourceLocation.fromNamespaceAndPath("somemod", "golden_dagger"), goldRecipe));
    }
    ...
    void testParseAndOrCombinators() {
        ...
        assertTrue(rule.testJson(ResourceLocation.withDefaultNamespace("stick"), craftingRecipe));
        assertTrue(rule.testJson(ResourceLocation.withDefaultNamespace("iron_ingot"), blastingRecipe));
        assertFalse(rule.testJson(ResourceLocation.fromNamespaceAndPath("othermod", "iron_ingot"), blastingRecipe));
        assertFalse(rule.testJson(ResourceLocation.withDefaultNamespace("iron_pickaxe"), craftingRecipe));
    }
    ...
    void testInputTagFilterShorthand() {
        ...
        ResourceLocation id = ResourceLocation.withDefaultNamespace("test");
