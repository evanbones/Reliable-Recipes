...
public class BrewingRecipeManager {
    ...
    public static void reload(RecipeManager recipeManager) {
        ...
        for (BrewingRecipe brewingRecipe : recipeManager.getAllRecipesFor(BrewingRecipe.TYPE)) {
    ...
    public static boolean isBrewingRecipeRemoved(ItemStack input, ItemStack reagent, ItemStack output) {
        ...
        ResourceLocation dummyId = new ResourceLocation("minecraft", "brewing_vanilla_mix");
    ...
    public static JsonObject stackToJson(ItemStack stack) {
        ...
        if (potion != Potions.EMPTY) {
            ResourceLocation potionLoc = BuiltInRegistries.POTION.getKey(potion);
            JsonObject potionContentsObj = new JsonObject();
            potionContentsObj.addProperty("potion", potionLoc.toString());
            potionContentsObj.addProperty("potions", potionLoc.toString());
