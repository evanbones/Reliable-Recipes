...
public class SharedToastOverlay {
    ...
    public static void render(GuiGraphics guiGraphics) {
        ...
        boolean isInventory = mc.screen instanceof InventoryScreen || mc.screen instanceof CreativeModeInventoryScreen;
        ...
        if (!iconStack.isEmpty()) guiGraphics.renderFakeItem(iconStack, 8, 8);
